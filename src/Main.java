...
//        System.out.println(manager.getHistory());
        ...
        Subtask subtask1 = new Subtask("test", "test", Status.NEW, epic, Duration.ofHours(2),
                                        LocalDateTime.of(2003, 1, 28, 18, 30));
        Subtask subtask2 = new Subtask("test", "test", Status.NEW, epic, Duration.ofHours(3),
                                        LocalDateTime.of(2003, 1, 28, 16, 30));
        Subtask subtask3 = new Subtask("test", "test", Status.NEW, epic);
        manager.makeSubtask(subtask1);
        manager.makeSubtask(subtask2);
        manager.makeSubtask(subtask3);
        epic.updateDuration(manager.getAllSubtaskOfEpic(epic.getId()));
        System.out.println();
        for (Task task : manager.getPrioritizedTasks()){
            System.out.println(task + " time:" + task.getStartTime());
        }
    }
}
